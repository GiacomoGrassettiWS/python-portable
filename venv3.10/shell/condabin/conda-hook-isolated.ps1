...
$Env:PATH = "$Env:_CONDA_ROOT;$Env:_CONDA_ROOT/Scripts;$Env:_CONDA_ROOT/Library/mingw-w64/bin;$Env:_CONDA_ROOT/Library/usr/bin;$Env:_CONDA_ROOT/Library/bin;$Env:_CONDA_ROOT/bin;$Env:_CONDA_ROOT/condabin;"
